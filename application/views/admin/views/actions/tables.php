...
<div class="container-fluid">
            ...
            <div class="table-responsive">
                <form id="buscar" method="post" action="javascript:buscar('<?php echo $result[0]['database']; ?>');">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Buscar <?php echo($result[0]['nome']); ?>"
                               name="buscar" id="buscarCampo">
                    ...
                    if ($counthd > 0):
                        ...
                        if ($get->num_rows() > 0):
                            ...
                            foreach ($resultactions as $key => $value) {
                                ...
                                <a onclick="editar(' . $idmodal . ');" data-toggle="modal" data-target="#modalabrir' . $i . '" style="text-decoration:none;" title="Editar" class="fa fa-edit"></a>
                                &nbsp;
                                ...
                                <!-- Modal Editar -->
                                <div class="modal fade" id="modalabrir<?php echo $i; ?>" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="textotitle">
                                                    Editar <?php echo ucwords($result[0]['nome']); ?> -
                                                    <b><?php echo $idmodal; ?></b></h4>
                                            </div>         <script>

                                                function editarform(modal){


                                                    var form = $("#editform"+modal+"").serialize();

                                                    $.ajax({
                                                        url: '<?php echo base_url('AjaxControler/editleilao');?>',
                                                        data: form,
                                                        type: 'POST',
                                                        error: function (data) {
                                                            alert(data);
                                            ...
                                            <form id="editform<?php echo $idmodal;?>" method="post" action="javascript:editarform('<?php echo $idmodal;?>');">
                                                    ...
                                                    foreach ($resultcedit[0] as $key => $value) {
                                                        ...
                                                        if ($key <> 'bio' and $key <> 'lastname'):
                                                            ...
                                                            if ($key <> 'profile_image' and $key <> 'cover_image' and $key <> 'image_1' and $key <> 'image_2' and $key <> 'image_3' and $key <> 'image_4' and $key <> 'descricao_loja'):
                                                                ...
                                                                <div class="form-group">
                                                                    <label
                                                                        for="input<?php echo $key; ?>"><?php if ($key == 'firstname'): echo 'Nome';
                                                                        else: echo str_replace('_', ' ', ucwords($key)); endif; ?></label>
                                                                    <input type="email" name="<?php echo $key; ?>" class="form-control"
                                                                           id="input<?php echo $key; ?>"
                                                                           placeholder="<?php echo ucwords($key); ?>" <?php if ($key == 'id' or $key == 'fbid' or $key == 'pass' or $key == 'verify' or $key == 'type' or $key == 'id_medicamento' or $key == 'visible'): echo 'disabled="disabled"'; endif; ?>
                                                                ...
                                                                if ($key == 'profile_image'):
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="profile_image">Alterar Imagem -
                                                                            <b><?php echo str_replace('_', ' ', ucwords($key)); ?></b></label>
                                                                        <input name="<?php echo $key; ?>" type="file" id="profile_image">
                                                                    </div>
                                                                    <?php
                                                                ...
                                                                if ($key == 'cover_image'):
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="cover_image">Alterar Imagem -
                                                                            <b><?php echo str_replace('_', ' ', ucwords($key)); ?></b></label>
                                                                        <input name="<?php echo $key; ?>" type="file" id="cover_image">
                                                                    </div>
                                                                    <?php
                                                                endif;
  ...
  <?php echo $value; ?>
                                                    ...
                                                    <input type="hidden" name="tpdatabase" value="<?php echo $result[0]['database'];?>" />
                                                    ...
                                                    ?>
                                                    <input type="hidden" name="wherecond" value="<?php echo $keykey;?>" />
                                ...
                                <!-- Modal Excluir -->
                                <div class="modal fade" id="modalexcluir<?php echo $i; ?>" tabindex="-1" role="dialog"
                                     aria-labelledby="myModalLabel">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="textotitle">
                                                    Excluir <?php echo ucwords($result[0]['nome']); ?> -
                                                    <b><?php echo $idmodal; ?></b></h4>
                                            </div>
                                            <div class="modal-body">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button
                                                    onclick="excluir('<?php echo $result[0]['database']; ?>',<?php echo $idmodal; ?>,<?php echo $i; ?>)"
                                                    type="button" class="btn btn-danger">Confirmar
                                                </button>
                                            </div>
                                        </div>
                                    </div>
