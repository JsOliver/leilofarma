...
?>
    ...
    <div class="row" style="padding: 0 0 0 3%; ">
        ...
        if ($_POST['tipo'] <> 0):
            $this->db->like('produtos_disponiveis.categorias', $_POST['tipo']);
            $this->db->or_like('produtos_disponiveis.nome_prod', $_POST['keyword']);
                    ...
                    <div class="thumbnail product-img"
                        ...
                        <a style="position: absolute;top:30%; text-decoration:none;left: 38%; padding: 2% 4% 2% 4% ;color: white;font-weight: 600; background: #972227; float: right;"
                           class="add-to-cart"
                            ...
                            if ($countlg > 0):
                                ...
                                echo 'href="' . base_url('produto/' . str_replace(' ', '-', strtolower($fetchad[0]['nome_loja'])) . '/' . str_replace(' ', '-', str_replace($arrayreplace, '', strtolower(preg_replace( '/[`^~\'"]/', null, iconv( 'UTF-8', 'ASCII//TRANSLIT', $dds['nome'] ) ))))) . '/' . $dds['id_pdp'] . '"';
                            endif;
                            ?>
                        ><i
                        ...
                        <div class="caption">
                            <div style="float: left; width: 70%; padding-left: -10px;margin-right: 10px; ">
                                ...
                                <a data-toggle="modal" data-target="#lance<?php echo $dds['id_pdp'];?>" class="btn" style="background:#dc0000;width: 52%;color: white;border-radius: 0;padding: 3%;font-weight: 600;"><i class="fa fa-gavel" aria-hidden="true"></i> DAR LANCE</a>

                                <a href="<?php  echo $dds['link_produto'];?>" target="_blank" class="btn" style="background:#5481dc;width: 45%; color: white;border-radius: 0;padding: 3%;font-weight: 600;"> COMPRAR</a>
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div style="text-align: left;">
                                                                ...
                                                                <label style="width: 100%;">
                                                                    ...
                                                                    <span id="btns">   <a href="javascript:lance('<?php echo $result[0]['id_loja'];?>' , '<?php echo '#MD0'.$resultmed[0]['id'].''; ?>' , '<?php echo $dds['id_pdp'];?>');" class="btn"
...
if($count1 > 20):
?>
    <nav aria-label="" style=" left: 80%;margin: 0 0 0 35%;">
